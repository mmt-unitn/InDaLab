...
È una prova robusta che può essere applicata ad un ampio intervallo di durezze.
:::
...
* Il modello è un insieme di relazioni tra parametri che descrive le interazioni nel sistema e rappresenta lo strumento di misura. Può essere analitico, numerico o empirico; quest'ultimo non include informazioni sulla fisica completa del sistema.
...
:::column
![Campione prima (in basso) e dopo preparazione superficiale](images/preparazione_campioni.jpg){#Preparazione_campioni width=75% .un}
:::
:::
...
:::column
![Campioni numerati](images/campioni.jpg){width=75% #Campioni}
:::
:::
...
:::column
![Provino a contatto](images/contatto.jpg){width=50% #provino}
:::
:::
...
:::column
![Azzeramento del regolo](images/zeroregolo.jpg){width=50% #zeroregolo}
:::
:::
...
:::column
![Orientamento regolo](images/orientamento.jpg){width=50% #orientamento}
:::
:::
...
* Confermare con il tasto [f]{.bred}
:::

:::column
![Misura della diagonale](images/misura.jpg){width=50% #misura}
:::
:::
...
:::column
![Durometro EMCO TEST M4U 02](images/durometro.jpg){width=50% #Durometro}
:::
:::
...
È necessario creare una tabella di raccolta dati, in colonna i valori delle misure e delle stime fornite dalla macchina per tutti i 10 provini usando
...
## Confronto tra intentatore integro e danneggiato {.smaller}
...
df_a <- tibble(
  material=1:10,
  stima_OK=c(591,205,209,262,318,578,206,156,624,581),
  HV30_NOK = c(676,259,259,306,352,660,244,164,659,625),
  HV30_OK=c(662,242,262,302,330,641,244,165,668,651),
  stima_NOK = c(620,212,217,307,339,629,216,157,622,596),
  HV30_dd=c(648,256,253,297,351,652,247,166,659,635),
  stima_dd=c(612,219,218,297,337,621,218,157,618,596)
)

kable(head(df_a, n=10), caption = "Tabella di raccolta dati per T-test")
```
## Confronto tra intentatore integro e danneggiato
...
È necessario creare una tabella di raccolta dati. Si sceglie di indagare per 6 materiali differenti (rappresentanti 6 diverse durezze) la relazione tra stima e durezza effettiva per 5 scale differenti (HV5, HV10, HV20, HV30, HV50).
