...
kable(data_cali, caption="Concentrazione MB (mg/L) vs Assorbanza")
```
...
Si esegue quindi per ogni trattamento una regressione con un modello a decadimento esponenziale  dall'istante 0 per determinare il valore della costante *k*, unico parametro che descrive la velocità della reazione per il modello adottato.
...
In quanto il piano fattoriale utilizzato non prevede ripetizioni. attraverso il metodo di Daniel si verificano se siano presenti effetti o interazioni non significative.
...
Quindi, risulta che gli unici fattori che hanno un impatto significativo sulla velocità di reazione (e quindi sulla costante$k$) sono 
:::
